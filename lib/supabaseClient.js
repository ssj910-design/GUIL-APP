...
// ⚠️ 긴급 임시조치(2026-08-11): 커스텀 JWT를 Authorization 헤더로 보내면 Supabase가
// "JWT issued at future"(PGRST303)로 전체 조회를 401 처리해 화면이 텅 비는 실사고가
// 있었다 — 원인(레거시 시크릿 검증 방식) 조사 전까지 헤더 부착은 끄고 토큰 저장만 한다.
// 원인 확인되면 아래 createClient 호출에 헤더를 다시 붙일 것.
