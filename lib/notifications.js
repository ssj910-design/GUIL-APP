...
/** 관리자 알림(audience: "admin")만 받는 사람을 등급으로 좁힐 수 있다 — null(전체관리자) | admin_tier 값 */
export function audienceTierOf(item, orgSettings = {}) {
  return item.audience === "admin" ? (orgSettings[item.key]?.audienceTier ?? null) : null;
}
