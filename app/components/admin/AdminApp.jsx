...
export default function AdminApp() {
  ...
  useEffect(() => {
    ...
    async function load() {
      const [sites, units, siteManagers, failures, inspections, materials, quotes, restock, todos, billings, selfChecks, selfCheckItems, profiles, feed, errorCodes, unitPartPhotos, siteAssignments] =
        await Promise.all([
  ...
  return (
    ...
    <div className="min-h-screen lg:flex bg-slate-100 text-slate-900">
      ...
      <header className="lg:hidden sticky top-0 z-30 flex items-center gap-3 bg-blue-950 text-white px-4 py-3">
        ...
        <p className="ml-auto text-[10px] text-blue-300">{BRAND.name}</p>
      </header>
