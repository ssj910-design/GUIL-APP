...
import { handlePhoneInputChange } from "@/lib/utils";
          ...
          {step === 3 && (
            <>
              ...
              <div>
                ...
                <input className={inputCls} inputMode="numeric" placeholder="010-0000-0000" value={form.phone} onChange={(e) => handlePhoneInputChange(e, (v) => set({ phone: v }))} />
              </div>
              <div>
